...
class AddUserCommand extends Command
{
    ...
    protected function interact(InputInterface $input, OutputInterface $output): void
    {
        ...
        if (null !== $username) {
            ...
            $username = $this->io->ask('Username', null, null);
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->io->success(sprintf('%s was successfully created: %s (%s)', $isAdmin ? 'Administrator user' : 'User', $user->getLastname(), $user->getEmail()));
    ...
    private function validateUserData($username, $plainPassword, $email): void
    {
        ...
        $existingUser = $this->users->findOneBy(['lastname' => $username]);
